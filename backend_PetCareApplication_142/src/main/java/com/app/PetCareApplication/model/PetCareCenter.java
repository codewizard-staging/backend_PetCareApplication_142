package com.app.PetCareApplication.model;
...
import com.app.PetCareApplication.converter.DurationConverter;
import com.app.PetCareApplication.converter.UUIDToByteConverter;
import com.app.PetCareApplication.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"petcareapplication_419\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"petcareapplication_419\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"petcareapplication_419\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"petcareapplication_419\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"petcareapplication_419\"")
